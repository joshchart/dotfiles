...
/**
 * Prefer Codex GPT-5.3 for extraction when available, otherwise fallback to haiku or the current model.
 */
...
export default function (pi: ExtensionAPI) {
	const answerHandler = async (ctx: ExtensionContext) => {
			...
			// Select the best model for extraction (prefer Codex GPT 5.3, then haiku)
