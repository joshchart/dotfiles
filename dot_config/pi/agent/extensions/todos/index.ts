 ...
 * ~/.config/pi/history/<project>/todos, or the path in PI_TODO_PATH).  Each todo is a
...
const GLOBAL_PI_DIR = path.join(os.homedir(), ".config", "pi", "history");
...
function getTodosDirLabel(cwd: string): string {
	...
	return path.join("~/.config/pi/history", getProjectSlug(cwd), "todos");
}
...
export default function todosExtension(pi: ExtensionAPI) {
	...
	pi.registerCommand("todos", {
		description: "List todos from ~/.config/pi/history/<project>/todos",
