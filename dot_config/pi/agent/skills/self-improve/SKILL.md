...
| **Agent definitions** | Check `~/.config/pi/agent/agents/*.md` — are model choices, skills, or system prompts optimal for what was observed? |
...
|-------|---------------|---------|
| **Global** | `~/.config/pi/agent/` (AGENTS.md, skills, agents) | "Subagent worker should always run tests before committing" |
